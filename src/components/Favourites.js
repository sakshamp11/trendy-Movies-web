...
//function condn(obj,movieElem) {
  //return obj!=movieElem.id
//}
deletecurr=(movieElem)=>{
  let id=movieElem.id;
  let tarr=this.state.movies.filter(w=>w.id!=id)
                ...
                <tbody>
                  {filterArr.map((movieElem) => (
                    <tr>
                      ...
                      <td>
                        <button type="button" class="btn btn-danger"onClick={()=>this.deletecurr(movieElem)}>
                          Delete 
                        </button>
                      </td>
                    </tr>
